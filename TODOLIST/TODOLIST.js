...
-                  }
         ...
         */
        /**
         * TODO 5 将指定区域（单 多） 设为存储区   POST /region/modifyRegionStatusByRegionIds
         *
         * {
              "status": 0,   //需要修改成的状态
              "ids": [       //指定的单个或多个区域id
         ...
         */
        /**
         * TODO 6 将指定区域（单 多） 设为暂存区   POST /region/modifyRegionStatusByRegionIds
         */
        /**
         * TODO 7 将指定区域（单 多） 设为未设定区 POST /region/modifyRegionStatusByRegionIds
         */
        /**
         * TODO 8 将指定区域（单 多） 设为分拣区   POST /region/modifyRegionStatusByRegionIds
         */
        /**
         * TODO 9 将指定区域（单 多） 设为不合格去区  POST /region/modifyRegionStatusByRegionIds
         */
